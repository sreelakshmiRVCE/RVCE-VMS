...
<body class="animsition">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Add a New Visitor</strong>
                                    </div>
    ...
    echo $msg;
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="textarea-input" class=" form-control-label">Organization</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <textarea name="address" id="address"  placeholder="Organization" class="form-control" required=""></textarea>
                                                </div>
                                            </div>
                                            
                                             <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="password-input" class=" form-control-label">Department of visit</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                             ...
                                             <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="password-input" class=" form-control-label">Person to be visited</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="password-input" class=" form-control-label">Purpose of visit</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                        ...
                                        <p style="text-align: center;"><button type="submit" name="submit" id="submit" class="btn btn-dark btn-sm">Submit
                                        </button></p>
